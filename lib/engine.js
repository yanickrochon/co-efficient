...
module.exports = CoefficientEngine;


function CoefficientEngine(options) {
  if (!(this instanceof CoefficientEngine)) {
    return new CoefficientEngine(options);
  }
...
CoefficientEngine.extSep = EXT_SEP;

CoefficientEngine.exceptions = {
  EngineException: EngineException
};

Object.freeze(CoefficientEngine);
